...
#include <cmath>
#include <ctime>
// <windows.h> removed for portability during 2026 curation: the original 2018
// source included it but never called any Win32 API — it was a leftover from
// the MSVC/Windows dev environment the program was originally built in.
#include <vector>
#include <fstream>
using namespace std;
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void print_matr_1 (vector <vector <T> > & vArray){   //��������� ������� �� �����
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void print_matr_2 (vector <vector <T> > & vArray){   //��������� ������� �� �����
for (int i=0; i<vArray.size(); i++) 
{for (int j=0; j<vArray[i].size(); j++)
{if (j==vArray[i].size()-1) {cout<<"|"<<vArray[i][j]<<" ";}
...
vArray[i][vArray[i].size()-1]=vArray[i][vArray[i].size()-1]*(-1); //������� ���������� ������ ������ ������� ������
}
fin.close();
}//end of read_matr
//////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void print_matr_2_new (vector <vector <T> > & vArray){   //��������� ������� �� ����� �� ������ �������
cout<<"\t";                           //����� ������ ��� ��������� ������ ��������
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void fill_Ob_matr (vector <vector <T> > & vArray, vector <vector <T> > & vBrray) { //���������� �������� �������
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void fill_Ob_matr_plus_sol (vector <vector <T> > & vArray, vector <vector <T> > & vBrray) { //���������� �������� �������
for (int i=vBrray.size()/2; i<vBrray.size(); i++) {
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void print_matr_3 (vector <vector <T> > & vArray){ // ��� ��������� ��������� ������� �� ����� 
for (int i=0; i<vArray.size(); i++) 
{for (int j=0; j<vArray[i].size(); j++)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void fill_Vec_Sol (vector <vector <T> > & vArray, vector <vector <T> > & vBrray){ //���������� ������� �����
for (int i=vBrray.size()/2; i<vBrray.size(); i++) {
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void print_vect (vector <vector <T> > & vArray){ //��������� ������� �����
for (int i=0; i<vArray.size(); i++) 
{for (int j=0; j<vArray[i].size(); j++)
{
cout<<vArray[i][j]<<"\t";
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void multiply_line_matr(vector <T>  & vArray, vector <vector <T> > & vBrray, vector <T> & vCrray){ //��. ����. a(k) * ����. ����. = alpha(k)
for (int i=0; i<vCrray.size(); i++) //������������ ������� ����������
{vCrray[i]=0;}
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void multiply_line_vect (vector <T>  & vArray, vector <vector <T> >  & vBrray, vector <T> &c, vector <T> &delta){ //�������� a(k) * u(0) - c(k) = delta (k)
delta[0]=0;
...
delta[0]=delta[0]+c[0]; // �� � ��� � ������� ���� (c[0]) ���������� ��� �� ��'���� �����, ���� ��� ������ 
//delta[0]=-1*delta[0];  //?????????????????
}//end of multiply_line_vect
//////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
void recalculation (vector <vector <T> > & vArray, int k, vector <vector <T> > & vBrray, vector <vector <T> >  & vUrray){ //����������� k-�� �����
vector <T> temp1(vArray[k].size()-1,0); //����� ��� ���������� ����� a(k)
vector <T> temp11(temp1.size()); //���� ������� ����, ���� ���������� ��������� �������� ������� temp1 �� �������� �������
vector <T> temp2(1,0); //�����, �� ���������� �� ������� ����� �(k)
vector <T> temp22(temp2.size()); //���� ������� ����, ���� ���������� ��������� ���� ������ �� ��� �������� temp2

for (int i=0; i<vArray[k].size();i++){ //������� �������� ��������� ����� � ��� ������
...
cout<<"["<<k<<"]\t";
multiply_line_matr(temp1,vBrray,temp11); //�������� �������� ������� a(k) * �������� ������� = alpha(k)
...
cout<<endl<<endl;
int m=M[0].size()-1;
vector <vector <double> >Od(m, vector <double> (m+1,0)); //�������� ������� Od, = ������ M + ������� �� ����
identity_matr(Od);
...
vector <vector <vector <double> > >A(1, vector <vector <double> >(m*2, vector <double> (m+1,0))); //����� ��� �����������
int k=0;
fill_matr(M,Od,A[k]);
...
vector <vector <double> >Ob(m, vector <double> (m,0)); //������� ������� Ob, = ������ ������� ��� ������� ����'����
fill_Ob_matr(Ob,NEW_M);
print_matr_3(Ob); //��������� ��� ������� �� ����'������
cout<<endl<<endl;

cout<<"THE VECTOR OF SOLUTIONS"<<endl;
vector <vector <double> >Sol(m,vector <double>(1,-100));// m �������, 1 �������� (fixed typo "doubee" -> "double" for portability, 2026 curation)
...
vector <vector <double> >Ob_plus_Sol(m, vector <double> (m+1,0));//������� ������� Ob, = ������ ������� + ������� ����'����
fill_Ob_matr_plus_sol (Ob_plus_Sol,NEW_M);
print_matr_1(Ob_plus_Sol); //�������� 
cout<<endl<<endl;


cout<<"THE MATRIX, WHICH CONSISTS OF THE INITIAL MATRIX AND THE INVERSE MATRIX:"<<endl;
vector <vector <double> >CHANG_MATR(m*2, vector <double> (m+1,-100)); // ������ �� � ������, /� � �� ������ ��������
fill_matr(M,Ob_plus_Sol,CHANG_MATR);// ��������� ���������� l�������, ������ 7������ � ���� ��������� ��������

print_matr_2_new(CHANG_MATR);
cout<<endl<<endl;


cout<<"STEP 1. PLEASE, CHOOSE THE LINE IN THE MATRIX, WHICH YOU WANT TO CHANGE:"<<endl; //������ ����� �������
int l; //����� (line), ��� �� ������ ������
do {
cin>>l;	
